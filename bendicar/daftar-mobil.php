...
<head>
    ...
    <title>Daftar Mobil - Bendicar</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <header>
        <h1>Daftar Mobil Bendicar</h1>
        <nav>
            <ul>
    ...
    <section id="mobil-list">
        <div class="mobil-item">
            <img src="assets/images/mobil1.jpg" alt="Mobil 1">
            <h3>Mobil 1</h3>
        ...
        <div class="mobil-item">
            <img src="assets/images/mobil2.jpg" alt="Mobil 2">
            <h3>Mobil 2</h3>
